...
def _install_log_tee():
    log_dir = os.environ.get(
        'TAIPA_LOG_DIR',
        os.path.join(os.path.expanduser('~'), '.npcsh', 'taipa', 'logs'),
    )
    try:
...
if __name__ == "__main__":
    ...
    default_port = '7138' if is_dev else '5138'
    port = os.environ.get('TAIPA_PORT', default_port)
    frontend_port = os.environ.get('FRONTEND_PORT', '7338' if port == '7138' else '6338')
    ...
    start_flask_server(
        ...
        db_path=os.path.expanduser('~/.npcsh/taipa/taipa.db'),
