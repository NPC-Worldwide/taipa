...
/**
 * Self-contained update checker matching the incognide pattern.
 * Checks the app's GCS manifest on mount, shows an update badge in the title
 * bar, downloads + launches the installer, and prompts to quit & install.
 * Uses window.api.{checkForUpdates, getAppVersion, downloadAndInstallUpdate,
 * onUpdateDownloadProgress, openExternal, closeWindow}.
 */
const UpdateChecker: React.FC = () => {
  ...
  const handleClick = async () => {
    // If download finished, prompt to quit & install.
